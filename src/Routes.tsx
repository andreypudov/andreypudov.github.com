...
const photographyRoute = (page: Page) => (
  <Route
    path={page.getRoute()}
    element={<PhotographyAlbum album={page.getAlbum()} />}
    key={page.getAlbum().getTitle().getKey()}
  />
);
...
const drawingAlbumRoute = (page: Page) => (
  <Route
    path={page.getRoute()}
    element={<DrawingAlbum album={page.getAlbum()} />}
    key={page.getAlbum().getTitle().getKey()}
  />
);
...
const routes = () => {
  return (
    <Routes>
      ...
      <Route
        path="/photographs/russian-emirates/"
        element={<RussianEmirates />}
      />
      ...
      <Route
        path="/performances/gravity-falls/"
        element={<PerformanceAlbum album={GravityFalls} />}
      />
      <Route
        path="/performances/cure-for-wellness/"
        element={<PerformanceAlbum album={CureForWellness} />}
      />
      <Route
        path="/performances/mia-and-sebastian/"
        element={<PerformanceAlbum album={MiaAndSebastian} />}
      />

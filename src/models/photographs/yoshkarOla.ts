...
const YoshkarOla = new Album(
  ...
  [
    ...
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_007_large.webp",
      false,
      new Text(
        "YoshkarOla.",
        "Monument to Yoshkin сat, the hero of a colloquial expression with a similar sounding. Today Yoshkin cat is an integral part of Yoshkar-Ola brands. The authors of the monument are Anatoly Shirnin, Sergey Yandubaev, and Alexey Shilov.",
      ),
    ),
    new Photograph("/photographs/2014-05-10/2014-05-10_008_large.webp", true),
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_009_large.webp",
      true,
      new Text(
        "YoshkarOla.",
    ...
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_011_large.webp",
      false,
      new Text(
        "YoshkarOla.",
    ...
    new Photograph("/photographs/2014-05-10/2014-05-10_024_large.webp"),
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_025_large.webp",
      true,
      new Text(
        "YoshkarOla.",
        "The Spasskaya Tower is a smaller replica of the main tower on the eastern wall of the Moscow Kremlin which overlooks Red Square. The original tower was built in 1491 by the Italian architect Pietro Antonio Solari.",
      ),
    ),
    new Photograph("/photographs/2014-05-10/2014-05-10_026_large.webp", true),
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_027_large.webp",
      false,
      new Text(
        "YoshkarOla.",
    ...
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_034_large.webp",
      false,
      new Text(
        "YoshkarOla.",
        "The Blagoveshchenskaya Tower is another smaller replica of Moscow's Kremlin Spasskaya Tower in Yoshkar-Ola.",
      ),
    ),
    ...
    new Photograph(
      "/photographs/2014-05-10/2014-05-10_048_large.webp",
      false,
      new Text(
        "YoshkarOla.",
        "Tsarevokokshaisky Kremlin is a modern replica of the historical fortress, built in 1584 by the order of Tsar Feodor I.",
      ),
    ),

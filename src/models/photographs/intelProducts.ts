...
const IntelProducts = new Album(
  new Text("IntelProducts.Title", "Intel Software Products"),
  Genre.Event,
  new Date("2016-04-15"),
  new Photograph("/photographs/2016-04-15/2015-04-12_002.webp"),
  [
    new Photograph(
      "/photographs/2016-04-15/2015-04-12_001.webp",
      false,
      new Text(
        "IntelProducts.",
        "The work on splash screen design for Intel software products.",
      ),
    ),
    new Photograph("/photographs/2016-04-15/2015-04-12_002.webp"),

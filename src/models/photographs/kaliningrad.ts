...
const Kaliningrad = new Album(
  ...
  new Date("2016-08-30"),
  new Photograph(
    "/photographs/2016-08-24_30/2016-08-24_30_023_large.webp",
    false,
    new Text("Kaliningrad.", "Rybnaya Derevnya"),
  ),
  [
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_001_large.webp",
      false,
      new Text("Kaliningrad.", "Rybnaya Derevnya"),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_002_large.webp",
      true,
      new Text(
        "Kaliningrad.",
        "Königsberg Cathedral is a Brick Gothic-style monument located on Kneiphof island in the Pregel (Pregolya) river. It is the most significant preserved building of the former City of Königsberg, which was largely destroyed in World War II.\n\nDedicated to Virgin Mary and St Adalbert, it was built as the see of the Prince-Bishops of Samland in the 14th century. Upon the establishment of the secular Duchy of Prussia, it became the Lutheran Albertina University church in 1544. The spire and roof of the cathedral burnt down after two RAF bombing raids in late August 1944; reconstruction started in 1992, after the dissolution of the Soviet Union.",
      ),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_003_large.webp",
      true,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_004_large.webp",
      true,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_008_large.webp",
      false,
      new Text(
        "Kaliningrad.",
        "Hangers of the abandoned Noytif military airbase.\n\nNoytif was a military airbase in Baltiysk. It is located on the Vistula Spit, 5 kilometers southwest of Baltiysk center within the city proper, on the opposite side of the Strait of Baltiysk close to the westernmost point of Russia.\n\nOriginally constructed in the 1930s by Nazi Germany for the Luftwaffe, it was unused during World War II but was damaged by Allied bombings. In 1945 after the war ended, the airbase came into possession of the Soviet Union and entered limited service with the Soviet Air Force, who used the remains of the airbase to house a small number of interceptor alert pads.",
      ),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_009_large.webp",
      false,
      new Text(
        "Kaliningrad.",
        "Vistula Spit\n\nThe Vistula Spit is an aeolian sand spit, or peninsular stretch of land that separates Vistula Lagoon from Gdańsk Bay, in the Baltic Sea, with its tip separated from the mainland by the Strait of Baltiysk. The border between Poland (Pomeranian Voivodeship) and Kaliningrad Oblast, a semi-exclave of Russia, bisects it, politically dividing the spit in half between the two countries. The westernmost geographical point of Russia is located on the Vistula Spit. The Polish part contains a number of tourist resorts, incorporated administratively as the town of Krynica Morska.",
      ),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_010_large.webp",
      false,
      new Text("Kaliningrad.", "Abandoned Noytif military airbase."),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_011_large.webp",
      false,
      new Text(
        "Kaliningrad.",
        "Vistula Spit\n\nUntil the 13th century, the spit had navigable straits in the middle, which allowed the city of Elbing, part of the monastic State of the Teutonic Knights, direct access to the Baltic Sea. The natural closing of the straits in the late 13th century reduced Elbing's status as an important trading seaport. This and the Teutonic takeover of Danzig (Gdańsk) and Polish Pomerania in 1308 led to the increased importance of Gdańsk.\n\nDuring World War II, it became the last holdout of the remaining German soldiers in East Prussia, although the Soviets simply bypassed the spit after the East Prussian Offensive was decisively concluded, training their sights on the more important goal of capturing Berlin. The last Wehrmacht soldiers laid down their arms after the German Instrument of Surrender was signed.",
      ),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_012_large.webp",
      true,
      new Text(
        "Kaliningrad.",
        "A private house in Zelenogradsk\n\nZelenogradsk, prior to 1946 known by its German name Cranz, located 34 kilometers north of Kaliningrad, on the Sambian coastline near the Curonian Spit on the Baltic Sea. Population figures: 13,026 (2010 Census).\n\nIn its heyday, Zelenogradsk (as Cranz) was a popular seaside resort on Germany's eastern Baltic coast, comparable to Bognor Regis in England. However, at the end of World War II, the Soviets took over the town, and much of its tourist traffic has been diverted to nearby Svetlogorsk, formerly called Rauschen.",
      ),
    ),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_013_large.webp",
      false,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_019_large.webp",
      false,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_020_large.webp",
      false,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_025_large.webp",
      false,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_026_large.webp",
      false,
      new Text(
        "Kaliningrad.",
    ...
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_027_large.webp",
      false,
      new Text(
        "Kaliningrad.",
        'Fort #5 "King Frederick William III of Prussia"',
    ...
    new Photograph("/photographs/2016-08-24_30/2016-08-24_30_028_large.webp"),
    new Photograph("/photographs/2016-08-24_30/2016-08-24_30_029_large.webp"),
    new Photograph(
      "/photographs/2016-08-24_30/2016-08-24_30_030_large.webp",
      false,
      new Text(
        "Kaliningrad.",

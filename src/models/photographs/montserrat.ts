...
const Montserrat = new Album(
  ...
  [
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_001.webp",
      true,
      new Text("Montserrat.", "Montserrat seen from Monistrol de Montserrat"),
    ),
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_002.webp",
      false,
      new Text(
        "Montserrat.",
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_003.webp",
      true,
      new Text(
        "Montserrat.",
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_006.webp",
      false,
      new Text(
        "Montserrat.",
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_008.webp",
      true,
      new Text("Montserrat.", "New facade, work of Francesc Folguera"),
    ),
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_009.webp",
      true,
      new Text("Montserrat.", "Monestir de Montserrat and Roca de St. Jaume"),
    ),
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_013.webp",
      false,
      new Text(
        "Montserrat.",
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_016.webp",
      false,
      new Text(
        "Montserrat.",
        "The highest summit of Montserrat is called Sant Jeroni and stands at 1,236 meters above sea-level. It is accessible by hiking trails which connect from the top entrance to the Sant Joan funicular, the monastery, or the base of the mountain.",
      ),
    ),
    new Photograph("/photographs/2023-05-07/2023-05-07_017.webp", true),
    new Photograph("/photographs/2023-05-07/2023-05-07_018.webp"),
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_019.webp",
      false,
      new Text(
        "Montserrat.",
    ...
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_025.webp",
      true,
      new Text(
        "Montserrat.",
    ...
    new Photograph("/photographs/2023-05-07/2023-05-07_027.webp"),
    new Photograph(
      "/photographs/2023-05-07/2023-05-07_028.webp",
      false,
      new Text("Montserrat.", "Rock Formations on Montserrat Mountain"),
    ),

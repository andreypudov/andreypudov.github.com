...
const Perpignan = new Album(
  ...
  [
    ...
    new Photograph(
      "/photographs/2022-12-06/2022-12-06_004.webp",
      false,
      new Text("Perpignan.", "Perpignan Cathedral"),
    ),
    ...
    new Photograph(
      "/photographs/2022-12-06/2022-12-06_009.webp",
      false,
      new Text("Perpignan.", "Palace of the Kings of Majorca"),
    ),

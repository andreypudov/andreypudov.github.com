...
const BarcelonaAirport = new Album(
  new Text('BarcelonaAirport.Title', 'LEBL Barcelona El Prat International Airport'),
  Genre.Street,
  new Date('2023-05-17'),
  new Photograph('/photographs/2023-05-17/2023-05-17_011.webp'),
  [
   new Photograph('/photographs/2023-05-17/2023-05-17_001.webp', true, new Text('Montserrat.', 'Josep Tarradellas Barcelona–El Prat Airport is the largest and busiest airport in Catalonia, and the sixth busiest in Europe. In 2019, Barcelona Airport handled a record 52,686,314 passengers, up 5.0% from 2018. It is a hub for Level and Vueling, and a focus city for Air Europa, Iberia, EasyJet and Ryanair.')),
   new Photograph('/photographs/2023-05-17/2023-05-17_002.webp', true, new Text('Montserrat.', 'Ryanair DAC is an Irish ultra low-cost carrier founded in 1984. It is headquartered in Swords, Dublin, Ireland, and has its primary operational bases at Dublin and London Stansted airports. It forms the largest part of the Ryanair Holdings family of airlines and has Ryanair UK, Buzz, Lauda Europe, and Malta Air as sister airlines. It is Ireland\'s biggest airline and in 2016 became Europe\'s largest budget airline by scheduled passengers flown, carrying more international passengers than any other airline.')),
   new Photograph('/photographs/2023-05-17/2023-05-17_003.webp', true, new Text('Montserrat.', 'TAP Air Portugal is the flag carrier of Portugal, headquartered at Lisbon Airport which also serves as its hub. The airline was established on 14 March 1945 and began commercial services on 19 September 1946. TAP – Transportes Aéreos Portugueses – has been a member of the Star Alliance since 2005 and operates on average 2,500 flights a week to 90 destinations in 34 countries worldwide. The company has a fleet of 100 aircraft, all of which are manufactured by Airbus with the exception of 22 aircraft manufactured by Embraer and ATR, operating on behalf of the regional airline TAP Express.')),
   new Photograph('/photographs/2023-05-17/2023-05-17_004.webp', true, new Text('Montserrat.', 'Vueling is a Spanish low-cost airline based at Viladecans in Greater Barcelona with hubs at Barcelona–El Prat Airport (main), Paris-Orly Airport in Paris, France and Leonardo da Vinci–Fiumicino Airport in Rome, Italy (secondary). It is the largest airline in Spain, measured by fleet size and number of destinations. As of 2021, Vueling serves 122 destinations in Africa, Asia, Europe and the Middle East, and carried more than 34 million passengers in 2019. Since 2013, it has been an operating company of International Airlines Group, the parent company of British Airways and Iberia.')),

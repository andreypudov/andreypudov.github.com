...
const PartnersDay = new Album(
  ...
  [
    ...
    new Photograph('/photographs/2016-11-09/2016-11-09_002.webp', false,
      new Text('PartnersDay.', 'Sergey Sidorko, Sergey Khekhnev, and Natalia Muravieva\nEngeneering Managers, Software and Services Group')),
    new Photograph('/photographs/2016-11-09/2016-11-09_003.webp', false,
      new Text('PartnersDay.', 'Jody Pfotenhauer, Brad Benson, Marina Alekseeva, and William Savage')),
    ...
    new Photograph('/photographs/2016-11-09/2016-11-09_011.webp', false,
      new Text('PartnersDay.', 'Marina Alekseeva - Vice President, Software and Services Group')),
    new Photograph('/photographs/2016-11-09/2016-11-09_012.webp'),
    new Photograph('/photographs/2016-11-09/2016-11-09_013.webp', true,
      new Text('PartnersDay.', 'William Savage - General Manager, Corporate Vice President, One Intel Software & Architecture')),
    new Photograph('/photographs/2016-11-09/2016-11-09_014.webp', false,
      new Text('PartnersDay.', 'Jody Pfotenhauer - Director of Functional Safety Engineering, Automated Driving Group')),
    ...
    new Photograph('/photographs/2016-11-09/2016-11-09_026.webp', false,
      new Text('PartnersDay.', 'Pavel Egorov - Chief Executive Officer at Dell Technologies')),
    new Photograph('/photographs/2016-11-09/2016-11-09_027.webp'),
    new Photograph('/photographs/2016-11-09/2016-11-09_028.webp', false,
      new Text('PartnersDay.', 'Valentin Anisimov - Principal Software Architect at Harman')),
    new Photograph('/photographs/2016-11-09/2016-11-09_029.webp', false,
      new Text('PartnersDay.', 'Andrey Vitsenko - Senior Engineering Manager, Product Security Expert')),
    new Photograph('/photographs/2016-11-09/2016-11-09_030.webp', false,
      new Text('PartnersDay.', 'Maria Stashenko - Director at Design Thinking Center and Co-Founder of Wonderfull Laboratory')),
  ]);

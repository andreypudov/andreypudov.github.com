...
const NizhnyNovgorod = new Album(
  ...
  [
    ...
    new Photograph(
      "/photographs/2017-07-28/2017-07-28_003.webp",
      false,
      new Text(
        "NizhnyNovgorod.",
    ...
    new Photograph(
      "/photographs/2017-07-28/2017-07-28_006.webp",
      false,
      new Text("NizhnyNovgorod.", "Microdistrict Meshchersky Lake"),
    ),
    new Photograph(
      "/photographs/2017-07-01/2017-07-01_001.webp",
      false,
      new Text("NizhnyNovgorod.", "Volga River"),
    ),
    new Photograph(
      "/photographs/2017-07-01/2017-07-01_002.webp",
      false,
      new Text("NizhnyNovgorod.", "Volga River"),
    ),
    new Photograph(
      "/photographs/2017-07-01/2017-07-01_003.webp",
      false,
      new Text("NizhnyNovgorod.", "Volga River"),
    ),
    new Photograph(
      "/photographs/2017-06-12/2017-06-12_001.webp",
      false,
      new Text("NizhnyNovgorod.", "Molitovsky Bridge"),
    ),
    new Photograph(
      "/photographs/2017-01-29/2017-01-29_001.webp",
      true,
      new Text("NizhnyNovgorod.", "Deer Sculpture"),
    ),
    new Photograph(
      "/photographs/2017-01-29/2017-01-29_002.webp",
      false,
      new Text("NizhnyNovgorod.", "Deer Sculpture"),
    ),
    new Photograph(
    ...
    new Photograph(
      "/photographs/2017-02-02/2017-02-02_001.webp",
      false,
      new Text("NizhnyNovgorod.", "Nizhny Novgorod TV Tower"),
    ),
    new Photograph(
      "/photographs/2017-02-02/2017-02-02_002.webp",
      true,
      new Text("NizhnyNovgorod.", "Nizhny Novgorod TV Tower"),
    ),
    new Photograph(
      "/photographs/2015-07-21/2015-07-21_001.webp",
      false,
      new Text(
        "NizhnyNovgorod.",
        "Nizhny Novgorod from the paragliding launch pad in Switzerland park.",
      ),
    ),

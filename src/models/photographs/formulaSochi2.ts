...
const FormulaSochi2 = new Album(
  ...
  [
    ...
    new Photograph(
      "/photographs/2016-04-27_05-04/2016-04-27_05-04_007.webp",
      false,
      new Text("FormulaSochi2.", "Krasnaya Polyana Ski Resort"),
    ),
  ],
);

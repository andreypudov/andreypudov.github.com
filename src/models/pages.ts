...
const Pages = {
  RussianEmirates: new Page(
    RussianEmirates,
    PageType.Article,
    "/photographs/russian-emirates/",
  ),
  GoldenAge: new Page(GoldenAge, PageType.Article, "/photographs/golden-age/"),
  ImperialTown: new Page(
    ImperialTown,
    PageType.Article,
    "/photographs/imperial-town/",
  ),

  Favorites: new Page(
    Favorites,
    PageType.Photographs,
    "/photographs/favorite-photographs/",
  ),
  PeiPeiChen: new Page(
    PeiPeiChen,
    PageType.Photographs,
    "/photographs/pei-pei-chen/",
  ),
  ...
  Grapebusters: new Page(
    Grapebusters,
    PageType.Photographs,
    "/photographs/grapebusters/",
  ),
  Barcelona: new Page(
    Barcelona,
    PageType.Photographs,
    "/photographs/barcelona/",
  ),
  ...
  BarcelonaAirport: new Page(
    BarcelonaAirport,
    PageType.Photographs,
    "/photographs/barcelona-airport/",
  ),
  Montserrat: new Page(
    Montserrat,
    PageType.Photographs,
    "/photographs/montserrat/",
  ),
  Perpignan: new Page(
    Perpignan,
    PageType.Photographs,
    "/photographs/perpignan/",
  ),
  ElsEmpedratsDelMontseny: new Page(
    ElsEmpedratsDelMontseny,
    PageType.Photographs,
    "/photographs/els-empedrats-del-montseny/",
  ),
  Andorra: new Page(Andorra, PageType.Photographs, "/photographs/andorra/"),
  Gotheborg: new Page(
    Gotheborg,
    PageType.Photographs,
    "/photographs/gotheborg/",
  ),
  Oslo: new Page(Oslo, PageType.Photographs, "/photographs/oslo/"),
  Stockholm: new Page(
    Stockholm,
    PageType.Photographs,
    "/photographs/stockholm/",
  ),
  Puigmal: new Page(Puigmal, PageType.Photographs, "/photographs/puigmal/"),
  TuroDeLHome: new Page(
    TuroDeLHome,
    PageType.Photographs,
    "/photographs/turo-de-lhome/",
  ),
  CastilloDeMataplana: new Page(
    CastilloDeMataplana,
    PageType.Photographs,
    "/photographs/castillo-de-mataplana/",
  ),
  AndreyPudov: new Page(
    AndreyPudov,
    PageType.Photographs,
    "/photographs/andrey-pudov/",
  ),
  PoblenouCemetery: new Page(
    PoblenouCemetery,
    PageType.Photographs,
    "/photographs/poblenou-cemetery/",
  ),
  ...
  EkaterinaDomracheva: new Page(
    EkaterinaDomracheva,
    PageType.Photographs,
    "/photographs/ekaterina-domracheva/",
  ),
  IrinaDomracheva: new Page(
    IrinaDomracheva,
    PageType.Photographs,
    "/photographs/irina-domracheva/",
  ),
  ConqueringAmerica4: new Page(
    ConqueringAmerica4,
    PageType.Photographs,
    "/photographs/united-states-4.0/",
  ),
  IntelOffice: new Page(
    IntelOffice,
    PageType.Photographs,
    "/photographs/intel-office/",
  ),
  NizhnyNovgorod: new Page(
    NizhnyNovgorod,
    PageType.Photographs,
    "/photographs/nizhny-novgorod/",
  ),
  FormulaSochi3: new Page(
    FormulaSochi3,
    PageType.Photographs,
    "/photographs/formula-sochi-3.0/",
  ),
  Rekshino: new Page(Rekshino, PageType.Photographs, "/photographs/rekshino/"),
  ConqueringAmerica3: new Page(
    ConqueringAmerica3,
    PageType.Photographs,
    "/photographs/united-states-3.0/",
  ),
  AlinaCherdakova: new Page(
    AlinaCherdakova,
    PageType.Photographs,
    "/photographs/alina-cherdakova/",
  ),
  TatyanaBysheva: new Page(
    TatyanaBysheva,
    PageType.Photographs,
    "/photographs/tatyana-bysheva/",
  ),
  LookingForTheWind: new Page(
    LookingForTheWind,
    PageType.Photographs,
    "/photographs/looking-for-the-wind/",
  ),
  BalloonFestival: new Page(
    BalloonFestival,
    PageType.Photographs,
    "/photographs/balloon-festival/",
  ),
  ConqueringRome: new Page(
    ConqueringRome,
    PageType.Photographs,
    "/photographs/rome-malta/",
  ),
  RideInRekshino: new Page(
    RideInRekshino,
    PageType.Photographs,
    "/photographs/ride-in-rekshino/",
  ),
  KiraOrlova: new Page(
    KiraOrlova,
    PageType.Photographs,
    "/photographs/kira-orlova/",
  ),
  EkaterinaMalysheva: new Page(
    EkaterinaMalysheva,
    PageType.Photographs,
    "/photographs/ekaterina-malysheva/",
  ),
  ConqueringAmerica2: new Page(
    ConqueringAmerica2,
    PageType.Photographs,
    "/photographs/united-states-2.0/",
  ),
  ...
  RamonPalace: new Page(
    RamonPalace,
    PageType.Photographs,
    "/photographs/ramon-palace/",
  ),
  PartnersDay: new Page(
    PartnersDay,
    PageType.Photographs,
    "/photographs/partners-day/",
  ),
  ConqueringAmerica: new Page(
    ConqueringAmerica,
    PageType.Photographs,
    "/photographs/united-states/",
  ),
  Kaliningrad: new Page(
    Kaliningrad,
    PageType.Photographs,
    "/photographs/kaliningrad/",
  ),
  FormulaSochi2: new Page(
    FormulaSochi2,
    PageType.Photographs,
    "/photographs/formula-sochi-2.0/",
  ),
  LolitaRakhmatova: new Page(
    LolitaRakhmatova,
    PageType.Photographs,
    "/photographs/lolita-rakhmatova/",
  ),
  IntelProducts: new Page(
    IntelProducts,
    PageType.Photographs,
    "/photographs/intel-products/",
  ),
  FormulaSochi: new Page(
    FormulaSochi,
    PageType.Photographs,
    "/photographs/formula-sochi/",
  ),
  AsiaFarakshina: new Page(
    AsiaFarakshina,
    PageType.Photographs,
    "/photographs/asia-farakshina/",
  ),
  LakeBaikal: new Page(
    LakeBaikal,
    PageType.Photographs,
    "/photographs/lake-baikal/",
  ),
  LakeBaikalTeam: new Page(
    LakeBaikalTeam,
    PageType.Photographs,
    "/photographs/lake-baikal-team/",
  ),
  MilitaryMuseum: new Page(
    MilitaryMuseum,
    PageType.Photographs,
    "/photographs/military-museum/",
  ),
  Ekaterinburg: new Page(
    Ekaterinburg,
    PageType.Photographs,
    "/photographs/ekaterinburg/",
  ),
  YoshkarOla: new Page(
    YoshkarOla,
    PageType.Photographs,
    "/photographs/yoshkar-ola/",
  ),
  LittleRussia: new Page(
    LittleRussia,
    PageType.Photographs,
    "/photographs/little-russia/",
  ),
  MarinaAlekseeva: new Page(
    MarinaAlekseeva,
    PageType.Photographs,
    "/photographs/marina-alekseeva/",
  ),
  VeraKlemenova: new Page(
    VeraKlemenova,
    PageType.Photographs,
    "/photographs/vera-klemenova/",
  ),

  PencilSketches: new Page(
    PencilSketches,
    PageType.Drawings,
  ...
  BolshayaPokrovskaya: new Page(
    BolshayaPokrovskaya,
    PageType.TimeLapses,
    "/timelapses/bolshaya-pokrovskaya/",
  ),
  MaximGorky: new Page(
    MaximGorky,
    PageType.TimeLapses,
    "/timelapses/maxim-gorky/",
  ),
  Spit: new Page(Spit, PageType.TimeLapses, "/timelapses/spit/"),
  StateBank: new Page(
    StateBank,
    PageType.TimeLapses,
    "/timelapses/state-bank/",
  ),
  SwitzerlandPark: new Page(
    SwitzerlandPark,
    PageType.TimeLapses,
    "/timelapses/switzerland-park/",
  ),
  ZelenskySyezd: new Page(
    ZelenskySyezd,
    PageType.TimeLapses,
    "/timelapses/zelensky-syezd/",
  ),

  CureForWellness: new Page(
    CureForWellness,
    PageType.Performances,
    "/performances/gravity-falls/",
  ),
  GravityFalls: new Page(
    GravityFalls,
    PageType.Performances,
    "/performances/cure-for-wellness/",
  ),
  MiaAndSebastian: new Page(
    MiaAndSebastian,
    PageType.Performances,
    "/performances/mia-and-sebastian/",
  ),
};
...
export const Articles = pagesValues
  .filter((p) => p.getType() === PageType.Article)
  .sort(compareArticles);
export const Drawings = pagesValues
  .filter((p) => p.getType() === PageType.Drawings)
  .sort(compareArticles);
export const TimeLapses = pagesValues
  .filter((p) => p.getType() === PageType.TimeLapses)
  .sort(compareArticles);
export const Performances = pagesValues
  .filter((p) => p.getType() === PageType.Performances)
  .sort(compareArticles);

export const Photographs = pagesValues
  .filter((p) => p.getType() === PageType.Photographs)
  .sort(compareArticles);
export const EventPhotographs = Photographs.filter(
  (p) => p.getAlbum().getGenre() === Genre.Event,
);
export const FavoritePhotographs = Photographs.filter(
  (p) => p.getAlbum().getGenre() === Genre.Favorites,
);
export const NaturePhotographs = Photographs.filter(
  (p) => p.getAlbum().getGenre() === Genre.Nature,
);
export const PortraitPhotographs = Photographs.filter(
  (p) => p.getAlbum().getGenre() === Genre.Portrait,
);
export const StreetPhotographs = Photographs.filter(
  (p) => p.getAlbum().getGenre() === Genre.Street,
);

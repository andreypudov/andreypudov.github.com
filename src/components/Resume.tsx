  ...
  return (
    <Layout title={"Resume"}>
      <div className="container">
        ...
        <p className="lead text-muted mb-5">{t("Resume.DrivenProfessional")}</p>
                ...
                <ul id="education" className="clearfix">
                  ...
                  <li>
                    ...
                    <div className="description pull-right">
                      ...
                      <p>
                        <small>
                          <strong>{t("Resume.Thesis")}:</strong>&nbsp;
                          {t("Resume.TheUseOfNeuralNetworks")}
                        </small>
                      </p>
                    </div>
                  </li>
              ...
              <div className="box">
                ...
                <div className="job clearfix row">
                  ...
                  <div className="col-sm-9">
                    ...
                    <div className="description">
                      {t("Resume.DevelopedAnInnovative")}
                      <br />
                      <br />
                ...
                <div className="job clearfix row">
                  ...
                  <div className="col-sm-9">
                    <div className="profession">
                      {t("Resume.TechnicalLead")}
                    </div>
                    <div className="description">
                      {t("Resume.TookTheRoleOfTeamLeader")}
                      <br />
                      <br />
                      {t("Resume.LedBuildingOfNewProjectInfrastructure")}
                      <br />
                      <br />
                ...
                <div className="job clearfix row">
                  ...
                  <div className="col-sm-9">
                    <div className="profession">{t("Resume.SrEngineer")}</div>
                    <div className="description">
                      {t("Resume.SoftwareEngineerResponsibleForTheDesign")}
                      <br />
                      <br />
                      {t(
                        "Resume.DesignedAndDevelopedTheNewWebsiteArchitecture",
                      )}
                      <br />
                      <br />
                      {t("Resume.ImplementedAModernRoleBasedRightsModel")}
                      <br />
                      <br />
                ...
                <div className="job clearfix row">
                  ...
                  <div className="col-sm-9">
                    ...
                    <div className="description">
                      {t("Resume.MainSoftwareDeveloperForCommonLicensing")}
                      <br />
                      <br />
            ...
            <div className="curriculum-vitae">
              <div className="box clearfix">
                ...
                <div className="contact-item">
                  <a
                    href="mailto:mail@andreypudov.com"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <div className="contact-item">
                  ...
                  >
                    ...
                    <div className="description">
                      <small>https://linkedin.com/in/pudov</small>
                    </div>
                  </a>
                </div>
              </div>
                ...
                <div className="skills">
                  ...
                  <div className="skills-legend clearfix">
                    <div className="legend-left legend">
                      <small>{t("Resume.Beginner")}</small>
                    </div>
                    <div className="legend-left legend">
                      <span>
                        <small>{t("Resume.Proficient")}</small>
                      </span>
                    </div>
                    <div className="legend-right legend">
                      <span>
                        <small>{t("Resume.Expert")}</small>
                      </span>
                    </div>
                    <div className="legend-right legend">
                      <small>{t("Resume.Master")}</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="box">
                ...
                <div id="language-skills">
                  <div className="skill">{t("Resume.Russian")}</div>
                  <div className="skill">{t("Resume.English")}</div>
                </div>
              </div>
            ...
            <div className="curriculum-vitae">
              ...
              <figure className="recommendations">
                <blockquote className="blockquote">
                  <p>{t("Resume.AndreyWasATechnicalLeaderInMyTeam")}</p>
                </blockquote>
              ...
              <figure className="recommendations">
                <blockquote className="blockquote">
                  <p>{t("Resume.AndreyAndIWorkedInTheSameGroup")}</p>
                </blockquote>
                <figcaption className="blockquote-footer">
                  <a
              ...
              <figure className="recommendations">
                <blockquote className="blockquote">
                  <p>{t("Resume.IWorkedWithAndreyAsPart")}</p>
                </blockquote>
                <figcaption className="blockquote-footer">
                  <a
              ...
              <figure className="recommendations">
                <blockquote className="blockquote">
                  <p>{t("Resume.IWorkedWithAndreyForManyYears")}</p>
                </blockquote>
                <figcaption className="blockquote-footer">
                  <a

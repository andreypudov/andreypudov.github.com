    ...
    <Layout title = { 'Albums' }>
      <div className = 'container'>
        ...
        <div className = 'row'>
          ...
          <div className = 'col-md-4'>
            <Link to = '/photographs/els-empedrats-del-montseny' className = 'card bg-dark text-white gallery-image'>
              <img src = { ElsEmpedratsDelMontseny.getCover().src } className = 'card-img' alt = '' />
              <div className = 'card-img-overlay'>
                <h6 className = 'card-title'>{ ElsEmpedratsDelMontseny.getTitle() }</h6>
              </div>
            </Link>
          </div>
          <div className = 'col-md-4'>
            <Link to = '/photographs/andorra' className = 'card bg-dark text-white gallery-image'>

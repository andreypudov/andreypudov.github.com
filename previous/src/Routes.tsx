...
const photographyRoute = (page: Page) =>
  <Route path = { page.getRoute() } element = { <PhotographyAlbum album = { page.getAlbum() } /> } key = {page.getAlbum().getTitle().getKey()} />;

const drawingAlbumRoute = (page: Page) =>
  <Route path = { page.getRoute() } element = { <DrawingAlbum album = { page.getAlbum() } /> } key = {page.getAlbum().getTitle().getKey()} />;
